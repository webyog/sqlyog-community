...
CQueryObject::CreateObjectBrowser(HWND hwndparent)
{
	...
	wyUInt32    styles   =  WS_VISIBLE | WS_CHILD | TVS_HASBUTTONS | TVS_SHOWSELALWAYS | TVS_EDITLABELS | TVS_TRACKSELECT;
...
CQueryObject::CreateImageList()
{
    ...
    wyInt32     imgres[] = { IDI_SERVER, IDI_DATABASE, IDI_OPEN, IDI_TABLE, IDI_COLUMN, 
							 ...
							 IDI_OPEN, IDI_VIEW, IDI_OPEN, IDI_TRIGGER, IDI_OPEN, IDI_EVENT, IDI_OPEN, IDI_PRIMARYKEY, IDI_PRIMARYKEY, IDI_OVERLAYFILTER};
