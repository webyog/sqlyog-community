...
class TabTable : public TabQueryTypes
{
public:
    TabTable(MDIWindow* wnd, HWND hwndparent, MySQLTableDataEx* data = NULL);
	~TabTable();

    MySQLTableDataEx* GetTableData();
    ...
    MySQLTableDataEx* m_data;
    TabTable** m_preferencedptr;
};
