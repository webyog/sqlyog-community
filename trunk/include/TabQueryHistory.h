...
#ifndef _TABQUERY_HISTORY_H_
#define _TABQUERY_HISTORY_H_

#include "FrameWindowHelper.h"
#include "TabQueryTypes.h"

class TabQueryHistory : public TabQueryTypes
{
public:
    TabQueryHistory(MDIWindow* wnd, HWND hwndparent);
	~TabQueryHistory();
    ...
    WNDPROC             m_origproc;
    HWND                m_hwndedit;
    TabQueryHistory**   m_referencedptr;
    HMENU   m_hmenu;
